...
//		// 0....9,999 and count the number of times 5 and 9,995 appaer
...
//	}
//	std::cout << "-------------------\n";
//	std::cout << "Averages for " << NUMBER_OF_TRIALS << " trials: 5: " << total5 / NUMBER_OF_TRIALS
//		<< "  9995: " << total9995 / NUMBER_OF_TRIALS << '\n';
//}