...
//}
//
//// d1 and d2 are "equal" if their difference is less than a specified tolerance
...
//}
//
//// Display final test statitstics
//void Tester::report_results() const {
//	std::cout << "+---------------------------------------\n";
//	std::cout << "| " << total_count << " tests run, " <<total_count-error_count
//		<< " passed, " << error_count << " failed\n";
//	std::cout << "+---------------------------------------\n";
//}