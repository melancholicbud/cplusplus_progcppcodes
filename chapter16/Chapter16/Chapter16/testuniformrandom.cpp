...
//	// Make these double-precision floating-point numbers so
//	// the average computation at the end will use floating-point arithmetic.
//	double total5 = 0.0, total9995 = 0.0;
//
//	// Accumulate the results of 10 trials, with each trial generating
//	// 1,000,000,000 pseudorandom numbers
...
//		// Generate one billion pseudorandom numbers in the range 0...9,999
//		// and count the number of times 5 and 9,995 appear
...
//			<< std::setw(6) << count5 << "    9995: " << std::setw(6)
//			<< count9995 << '\n';
//		total5 += count5;
//		total9995 += count9995; // Accumulate the counts to average at the end
//	}
//	std::cout << "-------------------\n";
//	std::cout << "Averages for " << NUMBER_OF_TRIALS << " trials:  5:"
//		<< std::setw(6) << total5 / NUMBER_OF_TRIALS << "  9995: " << std::setw(6)
