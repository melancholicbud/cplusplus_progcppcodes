...
//	// Each Widget object is supposed to have
//	// its own unique serial_number
//	int serial_number;
//public:
//	// A Widget object's serial number is initialized from the
//	// shared serial_number_source variable which is incremented
//	// each time a Widget object is created
...
//};
//
//// Initialize the intial serial number;
